        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAdress = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryVariationId = table.Column<int>(type: "integer", nullable: false),
                    CategoryId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CategoryVariations_CategoryVariationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartProductVariation", x => new { x.CartsId, x.ProductVariationsId });
                    table.ForeignKey(
                        name: "FK_CartProductVariation_Carts_CartsId",
                        column: x => x.CartsId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartProductVariation_ProductVariations_ProductVariationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartProductVariation_ProductVariationsId",
                table: "CartProductVariation",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryVariationId",
                table: "Products",
